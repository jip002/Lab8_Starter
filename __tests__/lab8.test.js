describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    await button.click();
    let content = await root.$('button');
    let innerText = await (await content.getProperty('innerText')).jsonValue();
    //now innerText = remove from card
    //console.log(`the button innerText is: ====== ${innerText}`);
    await button.click();
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    let innerText = await (await cart.getProperty('innerText')).jsonValue();
    console.log(`the innerText of cart is: ======= ${innerText}`);
